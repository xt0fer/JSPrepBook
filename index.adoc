...
_(need a section on getting a repl.it account or (even better) use a repl on ZIPCODEs website? need to think on this.) (if we had a javascript repl, we could see progress and traffic and see how much code prospective students are doing.)_

_any section which is titled with TODO is aone that doesn't have a decent first draft yet._
