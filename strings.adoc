...
Take a look at these various ways of copy out a substring from some source string. In this case, the source string is name 'rapper'. 
...
We're using one of the three different substring methods to copy out some smaller piece of the 'rapper' string.
