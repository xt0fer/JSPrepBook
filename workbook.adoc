...
By completing these exercises, reading the companion _Fundamentals of Javascript_ book or taking one of ZipCodeWilmington's preparation sessions, someone who has never coded in any language before can use this as a place to start, to study and to get ready to take the ZipCodeWilmington admissions assessment. 
